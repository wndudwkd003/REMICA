...
class Config:
    ...
    model_id: str = (
        "FacebookAI/roberta-base"  #  answerdotai/ModernBERT-base | FacebookAI/roberta-base | microsoft/deberta-v3-base | allenai/longformer-base-4096 | google/bigbird-roberta-base
    )
